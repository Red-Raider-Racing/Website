...
class MerchItem(models.Model):
    ...
    item_name = models.CharField(max_length=200, help_text="Enter the item's name.")
...
class Car(models.Model):
    car_name = models.CharField(max_length=50, help_text="Enter the name of the car.")
    image = models.FileField(upload_to='cars/', help_text="Upload an image of the car.")
    chassis = models.CharField(max_length=200, help_text="Enter the chassis details of the car.")
    power_unit = models.CharField(max_length=200, help_text="Enter the power unit details of the car.")
    weight = models.CharField(max_length=200, help_text="Enter the weight of the car.")
    main_achievement = models.CharField(max_length=200, help_text="Enter the car's main achievement.")
    competition_placement = models.CharField(max_length=200, help_text="Enter the car's competition placement.")
